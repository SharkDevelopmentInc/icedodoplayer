...
class FSinglePopupManager {
  ...
  displayTestMapActionBlockedPopup() {
    const popupItem = {
      title: "Not allowed",
      bodyAsHtml: "This feature is not available while playing a test map.",
      buttons: []
    };
  ...
  getPointPopup(nextPointPopupIndex) {
    const ALL_POINT_POPUPS = [
      ...
      },
      {
        minPoints: 35,
        title: "Our sponsor",
        bodyAsHtml: `Hi, it's Jason, the creator of Ice Dodo. My first ever job was at Colonist.io and I'm here to recommend this game to you if you love Catan or board games.<br>
                    <a href='https://colonist.io/?referralCode=icedodo' target='_blank'>Play colonist.io</a>
                    <img src='/assets/other/colonistio.png' style='width: 200px'>`
      },
      {
        minPoints: 45,
        title: "Follow me",
...
class FSingleEndingManager extends FBaseEndingManager {
  ...
  async onDeath(deathMessage) {
    ...
    await this.autoRestartOnDeath(didStartPreroll, didDisplayControlChangePopup);
  }
...
class FMapLoader {
  ...
  static getUrl(mapId, mapUrl) {
    return mapUrl != null ? `https://fn.onionfist.com/icemaprun.js?${LATEST_MAP_CODE_VERSION}=${mapUrl}` : `/maps/${mapId}.js`;
  }
}
/*!
...
const VGame_vue_vue_type_style_index_0_scoped_18a4bb9a_lang = "";
const _withScopeId$8 = (n2) => (pushScopeId("data-v-18a4bb9a"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_5$8 = /* @__PURE__ */ createStaticVNode('<img id="overlayToggleSound" class="hoverGrow noDrag" src="' + _imports_0$3 + '" data-v-18a4bb9a><img id="overlayMenuButton" class="hoverGrow noDrag" src="' + _imports_2$2 + '" data-v-18a4bb9a><div id="overlayCurrentTime" class="textLarge overlayTime" data-v-18a4bb9a>TIME: ??</div><div id="overlayBestTime" class="textLarge overlayTime" data-v-18a4bb9a>BEST: ??</div><div id="overlayMapName" class="textLarge" data-v-18a4bb9a>??</div><div id="overlayFps" class="textLarge" data-v-18a4bb9a>?? FPS</div><div id="overlayInGameMessage" data-v-18a4bb9a>??</div><div id="overlayControlChangeContainer" data-v-18a4bb9a><div class="overlayControlChangeItem" id="overlayJumpEnabled" data-v-18a4bb9a><h1 class="textLarge" data-v-18a4bb9a>JUMP ENABLED</h1><img src="' + _imports_1$2 + '" data-v-18a4bb9a></div><div class="overlayControlChangeItem" id="overlayControlsReversed" data-v-18a4bb9a><h1 class="textLarge" data-v-18a4bb9a>CONTROLS REVERSED</h1><img src="' + _imports_2$1 + '" data-v-18a4bb9a></div><div class="overlayControlChangeItem" id="overlayDriftEnabled" data-v-18a4bb9a><h1 class="textLarge" data-v-18a4bb9a>DRIFT ENABLED</h1><img src="' + _imports_3$1 + '" data-v-18a4bb9a></div></div>', 8);
const _hoisted_13$2 = { id: "ending" };
const _hoisted_14$2 = /* @__PURE__ */ createStaticVNode('<div class="endingSpacer" data-v-18a4bb9a></div><h1 id="endingMakerName" class="textLarge" data-v-18a4bb9a>??</h1><div id="endingGradientStripe" data-v-18a4bb9a><h1 id="endingMapName" class="textLarge" data-v-18a4bb9a>??</h1><h1 id="endingMainText" class="textLarge" data-v-18a4bb9a>You won!</h1></div><div id="endingTime" class="textArial" data-v-18a4bb9a>TIME: ??</div><div id="endingDeathActions" data-v-18a4bb9a><img id="endingHelp" class="endingIcon hoverGrow" src="' + _imports_7$1 + '" data-v-18a4bb9a><div class="endingMenuButton buttonLarge noHighlight" data-v-18a4bb9a>Menu [X]</div><div id="endingDeathRestartButton" class="buttonLarge noHighlight" data-v-18a4bb9a>Restart [_]</div><img id="endingDeathInfo" class="endingIcon hoverGrow" src="' + _imports_7 + '" data-v-18a4bb9a></div><div id="endingWinActions" data-v-18a4bb9a><div class="endingMenuButton buttonLarge noHighlight" data-v-18a4bb9a>Menu [X]</div><div id="endingWinRestartButton" class="buttonLarge noHighlight" data-v-18a4bb9a>Play Again</div><div id="endingNextMapButton" class="buttonLarge noHighlight" data-v-18a4bb9a>Next [_]</div><img id="endingWinInfo" class="endingIcon hoverGrow" src="' + _imports_7 + '" data-v-18a4bb9a></div>', 6);
const _hoisted_20$2 = {
  key: 0,
  class: "textArial"
};
...
const VGame = /* @__PURE__ */ _export_sfc(_sfc_main$d, [["render", _sfc_render$d], ["__scopeId", "data-v-18a4bb9a"]]);
...
const VMenu_vue_vue_type_style_index_0_scoped_baf8b16b_lang = "";
const _withScopeId$6 = (n2) => (pushScopeId("data-v-baf8b16b"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_40 = /* @__PURE__ */ _withScopeId$6(() => /* @__PURE__ */ createBaseVNode("p", { class: "textSmall colorGray3" }, [
  ...
  /* @__PURE__ */ createBaseVNode("span", null, "Ice Dodo Version 0.165")
], -1));
...
const VMenu = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$a], ["__scopeId", "data-v-baf8b16b"]]);
...
const VCredits_vue_vue_type_style_index_0_scoped_0a21433e_lang = "";
const _withScopeId$5 = (n2) => (pushScopeId("data-v-0a21433e"), n2 = n2(), popScopeId(), n2);
...
const _hoisted_3$9 = /* @__PURE__ */ createStaticVNode('<div class="creditsMain" data-v-0a21433e><p class="textLarge" data-v-0a21433e>Developer</p><p class="textArial" data-v-0a21433e>Jason</p><ul style="text-align:left;" data-v-0a21433e><li data-v-0a21433e>Email: flyingdodo9000@gmail.com</li><li data-v-0a21433e><span data-v-0a21433e>Instagram:</span><a href="https://www.instagram.com/seojoon.y/" target="_blank" class="clickableText textArial" data-v-0a21433e>@seojoon.y [CLICK]</a></li></ul><p class="textLarge" data-v-0a21433e>Music</p><p class="textArial" data-v-0a21433e>Valkyrie, Peneumatic Tokyo, Stairways, Uprise and Bloom by EnV</p><p class="textArial" data-v-0a21433e>Ice Dodo Theme and Down Caves by ColBreakz</p><p class="textArial" data-v-0a21433e>Dodozart, Dodosynthesis and Brink by The Insolence Watches You</p><p class="textLarge" data-v-0a21433e>Map makers</p><p class="textArial" data-v-0a21433e>Kazil, dododo73, Carrots, skilledandkilled, Xdoomination, Furby, Rocky707, rytai3, TimTam, Bearded Baby, Cr43zy, DRV, Squirrel, Sungjoon, Usern, June, A_KittenIsh_exponent, datoneguy246, have2go2p, heck, Helloe, Maplez, Masterminx9000, Milesrad, neonturtle, Revelboy, Rionte, skywolf, Soviet Coconut, thero, happyhockey, Jay, Ghoullsh, Gold3n d0d0, AnimeFan, David Ye, Anperson, Jaspko, uPilot, Destroyer, Moosh, Catfishpie, DonW15, FNX, ABC123, Moose_ManOK, Leo, Icy Chicken, Burgerhero48, Zhou Yu, Tomtec, Jerwo, awehero54</p><p class="textLarge" data-v-0a21433e>Pixel art</p><p class="textArial" data-v-0a21433e>ItsYaBoiPoppin, Furby, Daniel, The Unsuspicious Imposter, anperson, Thero, Catfishpie, The Insolence Watches You, legendofme, supasnugz, ABC123, donkeyduo, beanos, FNX, Shogun, Future Pro, JayTheMystic, Destroyer, dwn, Ghoul, dwn, jAy, Unknown66, thezoomerguy, RunningOutOfSpaceToTypeInMyUsern, hotasiankid, skilledandkilled</p><p class="textLarge" data-v-0a21433e>Special thanks</p><p class="textArial" data-v-0a21433e>Furby, sungjoon, parke, sleepyhatake, skywolf, masterclutch, Golden, Rocky707, Thero, Jerome, Yusof (Discord: Yusof#2500)</p><p class="textLarge" data-v-0a21433e>Partners</p><p class="textArial" data-v-0a21433e>Doppler, Kristian</p></div>', 1);
...
const VCredits = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$9], ["__scopeId", "data-v-0a21433e"]]);
...
const _sfc_main = defineComponent({
  ...
  methods: {
    ...
    onClickMap(mapListing, mapUrl) {
      ...
      if (window.bagManager != null)
        window.bagManager.verticalBagManager.hideVertical();
    },
    returnToMenuFromGame() {
      ...
      window.currentPageId = this.mainState.pageId;
      if (window.bagManager != null)
        window.bagManager.verticalBagManager.showVertical();
    },
    changePageId(pageId) {
      this.playClickSound();
...
const VSingleplayer_vue_vue_type_style_index_0_scoped_15eff5e2_lang = "";
const _hoisted_1 = {
  key: 0,
  class: "main"
};
...
const VSingleplayer = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-15eff5e2"]]);
export {
